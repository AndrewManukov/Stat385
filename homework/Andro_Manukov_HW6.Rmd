...
- tentative title of the project
  -Chicago Food Inspections (old)
  -Chicago Area Restaurants Near Me! (new)
- the dataset
  -Chicago Food Inspections
- summary of the intentions and goals of the project
  -Observe risk and result (pass/fail) of food areas in chicago. (old)
...
- storyboard
  -Issue: People dont really know where the safest/best restaurants to eat at
  -Demonstrate Issue: Show how difficult it is to diffirentiate between restaurants in the chicago area
  -Ideas for overcomming issue: Create an easy way to visualize/interpret user chosen restaurants
  -Description of 
  -Solution: Have the ability to seperate the food areas based on risk and 
