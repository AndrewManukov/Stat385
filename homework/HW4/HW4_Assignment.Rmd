...
```{r}
plot(food$Latitude, food$Longitude)
points(x = 41.88, y = -87.61, pch = 19, col = "blue") #Aqua Tower
```

b. explain what is good and what is bad about the visualization
Bad: No titles, hard to tell whats going on. 
Good: Blue colored point helps Aqua Tower stand out. 

c. show a substantially improved visualization
```{r}
food$Color= "grey"
food$Color[food$Results == "Pass"] = "chartreuse2"
food$Color[food$Results == "Fail"] = "darkgray"
plot(food$Latitude, food$Longitude, xlab = "Latitude", ylab = "Longitude", main = "Passing Food Areas in Relation to Aqua Tower", col = food$Color, ylim = c(-87.7, -87.55), xlim = c(41.8, 41.95))
...
-Zoomed in on the plot to better fill the needs of someone living in Aqua Tower 
These 3 improvements give the plot some meaning. The first plot was just a plot of all the eating areas along with a blue point signifying Aqua Tower. This new plot gives someone living near Aqua Tower the knowledge of whether the places near them are able to pass inspections.  
